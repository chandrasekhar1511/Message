          ...
          <div class="post_content">
              ...
              <div>
                  <img src="images/admin.jpg" width="500" height="250"><br></br>
                      <h2><font color="red">Click here to Upload Files</font></h2>
              </div>
              <form action="callup.jsp" method="get" name="f1" onsubmit="return check()">
                  Publickey must have morethan 6 letter<br>
              <input type="text" name="publickey" style="width: 120px; height: 40px;" placeholder="Enter Public Key">
                  <input type="submit" value="FileUpload" style="width: 100px; height: 40px; color: greenyellow; background: red"/>  
    </form><br></br>
